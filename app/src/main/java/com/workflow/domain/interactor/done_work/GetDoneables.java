...
public class GetDoneables extends SingleUseCase<GenericListResponseModel<DoneWorkListModel>, RequestModel> {
    private final DoneWorkRepository repository;

    public GetDoneables(DoneWorkRepository repository) {
        this.repository = repository;
    }

    @Override
    public Single<GenericListResponseModel<DoneWorkListModel>> buildUseCaseSingle(RequestModel params) {
        return repository.getDoneables(params);
    }
}
